...
int main(){
    ...
    // solicita o valor do primeiro inteiro e armazena em num_1
    printf("Digite o valor do primeiro inteiro:\n");
    scanf("%d", &num_1);
    // solicita o valor do segundo inteiro e armazena em num_2
    printf("Digite o valor do segundo inteiro:\n");
    scanf("%d", &num_2);
    
    // realiza a soma dos inteiros e armazena na variável "soma"
    soma = num_1 + num_2;
